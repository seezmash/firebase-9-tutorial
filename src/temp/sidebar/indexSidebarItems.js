let theList = [
  {
    ...
    tags: ['Minecraft', 'Rust', 'Valorant', 'Youtube'],
    oneLiner:
      'Electronic Sports & Gaming Entertainment Organization 🇿🇦'
  },
    {
    name: 'Goliath Gaming',
  ...
  },
  {
    ...
    tags: ['Minecraft', 'Rust', 'Valorant', 'Youtube'],
    oneLiner: '😊Meet Cool New Members And Soon To Be Friends'
  },
  {
    name: 'Legacy ZA',
    image: '/img/groups/legacy.jpg',
    tags: ['Gaming', 'Rust', 'Scum', 'Youtube'],
    oneLiner: 'PUBG and variety streamer'
  },
    {
    name: 'Sinister5',
  ...
  },
  {
    ...
    oneLiner: 'I like long walks on the beach'
  },
  {
